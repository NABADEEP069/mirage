...
const AnswerPanel = ({ question }: Props) => {
  ...
  if (!question) {
    return (
      <div className="w-2/3 bg-[#21222c] p-6 rounded-lg shadow-lg flex items-center justify-center">
  ...
  return (
    <div className="w-2/3 bg-[#21222c] p-6 rounded-lg shadow-lg flex flex-col gap-6">
      <div>
